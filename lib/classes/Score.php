<?php
/**
 * Keeps track of a zip codes score
 */
namespace elly;
...
final class DataProcessor {
	...
	/**
	 * @var $_scores: the aggregated data
	 */
	...
	public function loadData() {
		...
		//set up our scores data structure
		foreach( $this->_zipCodeNeighboorMap as $zip => $ignore ) {
			$this->_scores[ $zip ] = new Score;
		}
	}
