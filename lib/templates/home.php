...
<script>
	var censusDataJSON = <?=json_encode( $censusData, JSON_FORCE_OBJECT | JSON_PRETTY_PRINT | JSON_NUMERIC_CHECK );?>;
	var foodDataJSON = <?=json_encode( $foodData, JSON_FORCE_OBJECT | JSON_PRETTY_PRINT | JSON_NUMERIC_CHECK );?>;
</script>
